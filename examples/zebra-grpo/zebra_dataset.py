...
def cl_position(sol, cats, N, rng):
    ...
    # Capitalise the leading article if needed
    np = phrase(cat, val)
    ...
    with open(args.out, "w", encoding="utf-8") as f:
        ...
        while written < args.n:
            ...
            row = {
                ...
                "solution": p["solution"],
                "categories": p["categories"],   # full dict: cat -> [values]
